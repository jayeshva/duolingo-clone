    ...
    <div className="flex-col p-4  pt-1 pl-0 w-[380px] fixed top-5 right-28 h-screen overflow-auto">
      ...
      <div className="flex flex-col items-center tracking-normal bg-white rounded-2xl p-4 pb-5 border-2 border-[#E5E5E5]">
        ...
        <button
          ...
          className="
          tracking-wider
          bg-[#58cc05] text-white font-bold py-3 w-full rounded-2xl
        ...
        <button
          className="bg-[#1CB0F6] text-white tracking-wider shadow-[0_5px_0_#1999D6] font-din-round
          text-[14px] font-bold w-full mt-4 py-3 rounded-2xl active:shadow-none active:translate-y-[5px] hover:bg-sky-400 transition"
        >
          SIGN IN
        </button>
      </div>
